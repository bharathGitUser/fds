...
public class OriginalMap extends GenericMap<Integer,Integer> implements MessageHandler,Serializable{
	int myId;
	
	public OriginalMap(int myId){
		this.myId = myId;
	}
...
//				outStream.writeObject(this.size()*(4+Util.nodeDataSize));//data + next
    ...
    public static void main(String[] args) {
    	...
    	OriginalMap list = new OriginalMap(id);
