...
public class ReplicationMapOracle {
    ...
    public ReplicationMapOracle(int numStructures, int maxFaults){
...
*/
    ...
    public static void main(String[] args) {
    	...
    	ReplicationMapOracle orc = new ReplicationMapOracle(numPrimaries,numFaults);
