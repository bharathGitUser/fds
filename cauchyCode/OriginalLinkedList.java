...
public class OriginalLinkedList extends LinkedList<Integer> implements MessageHandler,Serializable{
	int myId;
	
	public OriginalLinkedList(int myId){
		this.myId = myId;
	}
...
//				outStream.writeObject(this.size()*(4+Util.nodeDataSize));//data + next
    ...
    public static void main(String[] args) {
    	...
    	OriginalLinkedList list = new OriginalLinkedList(id);
