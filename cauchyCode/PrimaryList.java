...
public class PrimaryList implements MessageHandler{
	...
	public PrimaryList(int numFaults, int primaryId, List<PrimaryNode<Integer>> primaryList){
	...
	public static void main(String[] args) {
    	...
    	PrimaryList fusibleList = new PrimaryList(numFaults, id,list); 
