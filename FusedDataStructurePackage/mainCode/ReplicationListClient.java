...
public class ReplicationListClient {
    ...
    public ReplicationListClient(int numStructures, int maxFaults){
...
*/
    ...
    public static void main(String[] args) {
    	...
    	ReplicationListClient orc = new ReplicationListClient(numPrimaries,numFaults);
